...
import com.crust.pochen.dribbbo.view.bucket_list.BucketListActivity;
...
public class ShotFragment extends Fragment {
    ...
    public void bucket() {
        if (collectedBucketIds == null) {
            Snackbar.make(getView(), getString(R.string.shot_detail_loading_buckets), Snackbar.LENGTH_LONG).show();
        } else {
